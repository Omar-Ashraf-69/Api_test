...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( UserModel user)?  success,TResult Function( Failure error)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( UserModel user)  success,required TResult Function( Failure error)  failure,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( UserModel user)?  success,TResult? Function( Failure error)?  failure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Success() when success != null:
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $CreateUserStateCopyWith<$Res> {
...
class _Failure implements CreateUserState {
...
@override
String toString() {
  return 'CreateUserState.failure(error: $error)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $CreateUserStateCopyWith<$Res> {
